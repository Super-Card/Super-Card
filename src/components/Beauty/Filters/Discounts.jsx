      ...
      <div className="beauty-filters">
        ...
        <label htmlFor="10%">
          <input
            ...
            id="10%"
            value="10%"
            onClick={event => this.props.beauty.setFilter('10%', event)}
          />10%
        </label>
        <label htmlFor="15%">
          <input
            ...
            id="15%"
            value="15%"
            onClick={event => this.props.beauty.setFilter('15%', event)}
          />15%
        </label>
        <label htmlFor="20%">
          <input
            ...
            id="20%"
            value="20%"
            onClick={event => this.props.beauty.setFilter('20%', event)}
          />20%
        </label>
        <label htmlFor="25%">
          <input
            ...
            id="25%"
            value="25%"
            onClick={event => this.props.beauty.setFilter('25%', event)}
          />25%
        </label>
        <label htmlFor="30%">
          <input
            ...
            id="30%"
            value="30%"
            onClick={event => this.props.beauty.setFilter('30%', event)}
          />30%
        </label>
      </div>
    );
